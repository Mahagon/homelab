...
variable "home_assistant_hostname" {
  ...
  validation {
    condition     = var.home_assistant_hostname == "homeassistant.danieljacobs.de"
    error_message = "This stack is intentionally restricted to homeassistant.danieljacobs.de."
  }
}
...
variable "home_assistant_url" {
  ...
  type        = string
  default     = "https://homeassistant.danieljacobs.de"
...
variable "cloudflare_zone_id" {
  description = "Cloudflare zone identifier for danieljacobs.de."
  type        = string
